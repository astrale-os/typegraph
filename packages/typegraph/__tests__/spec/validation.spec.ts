...
describe('Query Validation', () => {
  ...
  describe('Edge Property Validation', () => {
    ...
    it('rejects invalid edge properties', () => {
      expect(() => validator.validateEdgeProperty('authored', 'invalid')).toThrow(
  ...
  describe('Traversal Validation', () => {
    ...
    it('rejects invalid traversals', () => {
      ...
      expect(() => validator.validateTraversal('post', 'authored', 'out')).toThrow(
        QueryValidationError,
      )
      // user cannot traverse authored inbound (it's the source)
      expect(() => validator.validateTraversal('user', 'authored', 'in')).toThrow(
        QueryValidationError,
      )
      // comment has no connection to authored
      expect(() => validator.validateTraversal('comment', 'authored', 'out')).toThrow(
        QueryValidationError,
      )
    })
