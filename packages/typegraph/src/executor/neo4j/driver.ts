/**
 * Neo4j/Bolt Database Driver
 *
 * Database driver implementation for Neo4j, Memgraph, and other Bolt-compatible databases.
 */
...
export class Neo4jDriver implements DatabaseDriverProvider {
  ...
  private convertSummary(summary: ResultSummary): QuerySummary {
    return {
      resultAvailableAfter: summary.resultAvailableAfter?.toNumber(),
      resultConsumedAfter: summary.resultConsumedAfter?.toNumber(),
 ...
 */
export function createNeo4jDriver(config: DriverConfig): Neo4jDriver {
