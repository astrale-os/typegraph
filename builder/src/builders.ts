...
export interface RefSchema<D, IncludeData extends boolean = false> extends z.ZodType<{ readonly id: string }> {
...
export function ref<D extends NodeDef<any> | IfaceDef<any>>(target: D, opts: { data: true }): RefSchema<D, true>
export function ref<D extends NodeDef<any> | IfaceDef<any>>(target: D, opts?: { data?: boolean }): RefSchema<D> {
