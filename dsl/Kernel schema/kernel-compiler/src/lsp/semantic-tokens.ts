...
SEMANTIC_TOKEN_TYPES.forEach((t, i) => { TYPE_INDEX[t] = i; });

const MOD_INDEX: Record<string, number> = {};
SEMANTIC_TOKEN_MODIFIERS.forEach((m, i) => { MOD_INDEX[m] = 1 << i; });
...
const MODIFIER_KEYWORDS = new Set([
  "unique", "readonly", "indexed", "no_self", "acyclic", "symmetric",
  "format", "match", "in", "length", "on_kill_source", "on_kill_target",
  "cascade", "unlink", "prevent", "asc", "desc",
]);
