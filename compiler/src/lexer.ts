...
class Lexer {
  ...
  private readToken(): Token {
    ...
    this.pos++;
    switch (ch) {
      case "(": return this.token("LParen", start, this.pos);
      case ")": return this.token("RParen", start, this.pos);
      case "{": return this.token("LBrace", start, this.pos);
      case "}": return this.token("RBrace", start, this.pos);
      case "[": return this.token("LBracket", start, this.pos);
      case "]": return this.token("RBracket", start, this.pos);
      case "<": return this.token("LAngle", start, this.pos);
      case ">": return this.token("RAngle", start, this.pos);
      case ":": return this.token("Colon", start, this.pos);
      case ",": return this.token("Comma", start, this.pos);
      case "=": return this.token("Eq", start, this.pos);
      case "|": return this.token("Pipe", start, this.pos);
      case "?": return this.token("Question", start, this.pos);
      case "*": return this.token("Star", start, this.pos);
      default: {
